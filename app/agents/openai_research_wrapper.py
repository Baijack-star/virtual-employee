    ...
    try:
        ...
        if (
            ...
            return {
                ...
                "title": "Internal Error: No Report",
                "outline": [],
                "full_report_content": error_msg,
                "sources": [],
                "word_count": 0,
        ...
        return {
            "session_id": run_id,
            "summary": "Error: Critical Component Missing at Runtime",
            "details": [error_msg],
            "status": "error_configuration",
        ...
        return {
            "session_id": run_id,
            "summary": "Critical Error During Research Execution",
            "details": [error_msg],
            "status": "error_uncaught_exception",
            "title": "Uncaught Exception During Execution",
            "outline": [],
            "full_report_content": error_msg,
            "sources": [],
            "word_count": 0,
